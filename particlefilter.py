...
def gaussian_filter(code,env,timewindow=20000,dt=0.001,mode='Silent', dense=False):
...
def fast_particle_filter(code,env,timewindow=20000,dt=0.001,nparticles=20,mode='Silent',randomstate=np.random,testf = (lambda x: x), dense=False):
